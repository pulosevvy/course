        ...
        <div class="max-w-md mx-auto bg-grey-100 p-6 mt-12 rounded">
            <form class="space-y-5" method="POST" action="{{ route('admin.roles.update', $role->id) }}">
                ...
                <div>
                    ...
                    <input id="name" type="text" name="name" value="{{ $role->name }}" class="block w-full py-3 px-3 mt-2 text-gray-800 appearance-none border-2 border-gray-100 focus:text-gray-500 focus:outline-none focus:border-gray-200 rounded-md">
                    @error('name')
            ...
            <form class="space-y-5" method="POST" action="{{ route('admin.roles.permissions', $role->id) }}">
                ...
                <div>
                    ...
                    <label class="text-xl" style="max-width: 300px">
                        ...
                        <select name="permissions[]" class="block w-full py-3 px-3 mt-2 text-gray-800 appearance-none border-2 border-gray-100 focus:text-gray-500 focus:outline-none focus:border-gray-200 rounded-md" multiple>
